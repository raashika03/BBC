  ...
  return (
    <div className="App">
        ...
        <div class="transbox">
          ...
          <h3>
            ...
            <a href="https://www.facebook.com/rashika.sinha.75">
              <div class="img2">Rashika Rathi</div>
            </a>
          </h3>
        </div>
      </div>
      ...
      <footer id="contact">
        ...
        >
          <img
            src="https://raw.githubusercontent.com/raashika03/webtrial/master/social_media_logos/s1.png"
            width="20"
            height="20"
            alt="fb"
          ></img>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="https://twitter.com/raashika03" target="_blank" rel="noopener">
          <img
            src="https://raw.githubusercontent.com/raashika03/webtrial/master/social_media_logos/s2.webp"
            width="20"
            height="20"
            alt="twitter"
          ></img>
        ...
        >
          <img
            src="https://raw.githubusercontent.com/raashika03/webtrial/master/social_media_logos/s3.png"
            width="20"
            height="20"
            alt="IG"
          ></img>
        ...
        <br></br>
        <a
          href="https://www.pinterest.ca/rashikasinha32/"
          target="_blank"
          rel="noopener"
        >
          <img
            src="https://raw.githubusercontent.com/raashika03/webtrial/master/social_media_logos/s4.png"
            width="20"
            height="20"
            alt="PI"
          ></img>
        ...
        >
          <img
            src="https://raw.githubusercontent.com/raashika03/webtrial/master/social_media_logos/s5.jpg"
            width="20"
            height="20"
            alt="in"
          ></img>
